...
const Settings = () => {
    return (
        <>
            ...
            <InputSetting title="Tempat, Tanggal Lahir" isi="Masukan Tempat, Tanggal Lahir" />
            <InputSetting title="Jenis Kelamin" isi="Masukan Jenis Kelamin" />
            <InputSetting title="Nomor Telepon / Whatapp" isi="Masukan Nomor Telepon / Whatapp" />
            ...
            <div className="mt-5">
                <button
                className="btn bg-orange-500 text-white rounded-full px-10"
                >Simpan</button>
            </div>
            </div>
        </>
